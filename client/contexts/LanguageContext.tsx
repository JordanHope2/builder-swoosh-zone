...
const translations = {
  en: {
    ...
    "hero.subtitle":
      "AI-powered job matching that understands Swiss work culture, connects you with top employers, and accelerates your career growth.",
    ...
    "swipe_job.reviewed_all_positions":
    ...
    "featured.subtitle":
      "Discover hand-picked job opportunities from Switzerland's most prestigious companies. Quality positions for exceptional professionals.",
  ...
  de: {
    ...
    "hero.subtitle":
      "KI-gestütztes Job-Matching, das die Schweizer Arbeitskultur versteht, Sie mit Top-Arbeitgebern verbindet und Ihr Karrierewachstum beschleunigt.",
    ...
    "notifications.caught_up":
      "Sie sind auf dem neuesten Stand! Schauen Sie später wieder vorbei.",
    ...
    "swipe.subtitle":
      "Entdecken Sie personalisierte Job-Matches mit unserem intuitiven Swipe-Interface.",
    ...
    "swipe.advanced_search_text":
      "Möchten Sie detailliertere Suchoptionen sehen?",
    "swipe.advanced_search_cta": "Erweiterte Jobsuche →",

    // Swipe Job Discovery
    "swipe_job.great_job_exploring": "Tolle Arbeit beim Erkunden!",
    "swipe_job.reviewed_all_positions":
      "Sie haben alle verfügbaren Positionen überprüft. Überprüfen Sie Ihre Bewerbungen und gespeicherten Jobs.",
    ...
    "featured.subtitle":
      "Entdecken Sie handverlesene Stellenangebote von den renommiertesten Unternehmen der Schweiz. Qualit��tspositionen für außergewöhnliche Fachkräfte.",
    ...
    "ai.help_find_job":
      "Ich bin hier, um Ihnen dabei zu helfen, den perfekten Job zu finden! Ich kann Ihnen helfen:\n\n• Nach bestimmten Rollen suchen\n• Jobs nach Standort finden\n• Gehaltseinblicke erhalten\n• Sie mit Unternehmen zusammenbringen\n• Ihr Profil optimieren\n\nWas möchten Sie tun?",
    "ai.find_jobs_response":
      'Ich helfe Ihnen gerne beim Finden von Jobs! Nach welcher Art von Stelle suchen Sie? Sie können etwas wie "Software Engineer" oder "Marketing Manager" sagen.',
    "ai.zurich_jobs_response":
      "Hier sind einige großartige Möglichkeiten in Zürich:\n\n🚀 Software Engineer bei Google Zürich - CHF 120k-140k\n🏦 UBS Investment Banking - CHF 110k-150k\n📊 Credit Suisse Risikoanalyst - CHF 95k-120k\n\nSoll ich Ihnen bei der Bewerbung für eine davon helfen?",
    "ai.remote_jobs_response":
      "Hier sind ausgezeichnete Remote-Möglichkeiten von Schweizer Unternehmen:\n\n🏠 Remote Frontend Developer - Migros Digital - CHF 100k-120k\n📱 Flutter Developer - SBB - CHF 95k-115k\n📈 Product Manager - Swisscom - CHF 110k-130k\n\nSchweizer Unternehmen akzeptieren Remote-Arbeit mehr denn je. Soll ich Ihnen bei der Bewerbung helfen?",

    // AI Score
    "ai_score.title": "KI-Übereinstimmungsanalyse",
    "ai_score.subtitle":
      "Tiefer Einblick in Ihre Profilkompatibilität mit detaillierter Fähigkeitsanalyse und Markteinblicken",
    "ai_score.analyzing": "Analysiere Ihr Profil",
    "ai_score.computing":
      "Unsere KI berechnet detaillierte Skill-Matches und Markteinblicke...",
  ...
  fr: {
    ...
    "hero.subtitle":
      "Matching d'emploi alimenté par l'IA qui comprend la culture du travail suisse, vous connecte avec les meilleurs employeurs et accélère votre croissance de carrière.",
    ...
    "notifications.caught_up":
      "Vous êtes à jour ! Revenez plus tard pour les mises à jour.",
    ...
    "swipe.subtitle":
      "Découvrez des correspondances d'emploi personnalisées avec notre interface de swipe intuitive.",
    ...
    "swipe.advanced_search_text":
      "Voulez-vous voir des options de recherche plus détaillées?",
    "swipe.advanced_search_cta": "Recherche Avancée d'Emploi →",

    // Swipe Job Discovery
    "swipe_job.great_job_exploring": "Excellent Travail d'Exploration!",
    "swipe_job.reviewed_all_positions":
      "Vous avez examiné toutes les positions disponibles. Vérifiez vos candidatures et emplois sauvegardés.",
    ...
    "swipe_job.why_great_match":
      "Pourquoi Vous Êtes Une Excellente Correspondance",
    ...
    "featured.subtitle":
      "Découvrez des opportunités d'emploi sélectionnées avec soin des entreprises les plus prestigieuses de Suisse. Des postes de qualité pour des professionnels exceptionnels.",
  ...
  it: {
    ...
    "hero.subtitle":
      "Matching lavorativo alimentato da IA che comprende la cultura del lavoro svizzera, ti connette con i migliori datori di lavoro e accelera la tua crescita professionale.",
    ...
    "notifications.caught_up":
      "Sei aggiornato! Controlla più tardi per gli aggiornamenti.",
    ...
    "swipe.subtitle":
      "Scopri corrispondenze di lavoro personalizzate con la nostra interfaccia swipe intuitiva.",
    ...
    "swipe.advanced_search_text":
      "Vuoi vedere opzioni di ricerca più dettagliate?",
    "swipe.advanced_search_cta": "Ricerca Lavoro Avanzata →",

    // Swipe Job Discovery
    "swipe_job.great_job_exploring": "Ottimo Lavoro di Esplorazione!",
    "swipe_job.reviewed_all_positions":
      "Hai esaminato tutte le posizioni disponibili. Controlla le tue candidature e i lavori salvati.",
    ...
    "featured.subtitle":
      "Scopri opportunità di lavoro selezionate dalle aziende più prestigiose della Svizzera. Posizioni di qualità per professionisti eccezionali.",
  ...
  rm: {
    ...
    "hero.subtitle":
      "Matching da plazzas cun IA che chapescha la cultura da lavur svizra, connectescha cun ils megliers patrons e accelerescha vossa creschen da carriera.",
    ...
    "profile.subtitle":
      "Administrar vossas configuraziuns da conto e preferenzas",
    ...
    "notifications.caught_up":
      "Vus essas actual! Controlai pli tard per actualisaziuns.",
    ...
    "swipe.subtitle":
      "Scuvrir correspundenzas da plazzas personalisadas cun nossa interfatscha swipe intuitiva.",
    ...
    "swipe.advanced_search_text":
      "Vulais vesair opziuns da tschertga pli detagliadas?",
    "swipe.advanced_search_cta": "Tschertga Avanzada da Plazzas →",

    // Swipe Job Discovery
    "swipe_job.great_job_exploring": "Grond Lavur da Exploraziun!",
    "swipe_job.reviewed_all_positions":
      "Vus avais controllà tut las posiziuns disponiblas. Controllai vossas candidaturas e plazzas memorisadas.",
    ...
    "featured.subtitle":
      "Scuvrir pussaivladads da plazzas selecziunadas da las interprendas pli prestigiusas da la Svizra. Posiziuns da qualità per professiunists excepziunals.",
