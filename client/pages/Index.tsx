        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16 lg:mb-20">
            ...
            <p className="text-xl text-jobequal-text-muted dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
              ...
              JobEqual's Swiss-quality matching platform
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 items-center justify-items-center mb-20">
            <div className="text-3xl font-bold text-jobequal-text-muted dark:text-gray-400 hover:text-jobequal-green dark:hover:text-jobequal-green transition-colors duration-200 cursor-pointer">
              UBS
            </div>
            <div className="text-3xl font-bold text-jobequal-text-muted dark:text-gray-400 hover:text-jobequal-green dark:hover:text-jobequal-green transition-colors duration-200 cursor-pointer">
              Nestlé
          ...
          <div className="grid md:grid-cols-3 gap-12 lg:gap-16">
            <div className="text-center group">
              ...
              <div className="text-xl text-jobequal-text-muted font-medium">
                Active Jobs
              </div>
            </div>
            <div className="text-center group">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-12 lg:gap-16">
            <div className="md:col-span-1">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <span className="text-2xl font-bold text-jobequal-text">
                  JobEqual
                </span>
              </div>
            ...
            <div>
              <h4 className="font-bold text-jobequal-text mb-6 text-lg">
                For Job Seekers
              </h4>
              <ul className="space-y-3 text-jobequal-text-muted">
                <li className="hover:text-jobequal-green transition-colors duration-200 cursor-pointer">
                  Browse Jobs
                </li>
                <li className="hover:text-jobequal-green transition-colors duration-200 cursor-pointer">
                  Upload CV
          ...
          <div className="border-t border-jobequal-neutral-dark mt-12 pt-8 text-center">
            <p className="text-jobequal-text-muted text-lg">
              &copy; 2024 JobEqual. All rights reserved. Designed with Swiss
              precision.
            </p>
          </div>
        </div>
