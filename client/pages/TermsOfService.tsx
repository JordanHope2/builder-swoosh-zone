      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-xl text-jobequal-text-muted dark:text-gray-300 max-w-3xl mx-auto">
            These terms govern your use of JobEqual's platform and services. Please read them carefully to understand your rights and obligations.
          </p>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-jobequal-text dark:text-white mb-2">Fair Usage</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-jobequal-text dark:text-white mb-2">Data Rights</h3>
              <p className="text-sm text-jobequal-text-muted dark:text-gray-400">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-jobequal-text dark:text-white mb-2">Transparent Billing</h3>
              <p className="text-sm text-jobequal-text-muted dark:text-gray-400">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-jobequal-text dark:text-white mb-2">Swiss Law</h3>
              <p className="text-sm text-jobequal-text-muted dark:text-gray-400">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                    <ul className="space-y-3">
                      {section.content.map((item, itemIndex) => (
                        <li key={itemIndex} className="flex items-start text-jobequal-text dark:text-white">
        ...
        >
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-blue-800 dark:text-blue-200">International Users</h3>
            </div>
            <div className="space-y-3 text-blue-700 dark:text-blue-300 text-sm">
              <p>
                <strong>EU Residents:</strong> Additional consumer protection rights apply under EU law. 
                You may bring claims in your country of residence.
              </p>
              <p>
                <strong>Non-Swiss Residents:</strong> Local employment laws may affect job applications 
                and recruitment activities in your jurisdiction.
              </p>
              <p>
                <strong>Cross-Border Services:</strong> International job applications are subject to 
                destination country laws and employer requirements.
              </p>
            </div>
          </div>
          ...
          <div className="bg-green-50 dark:bg-green-900/20 rounded-2xl p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-green-800 dark:text-green-200">Billing & Refunds</h3>
            </div>
            <div className="space-y-3 text-green-700 dark:text-green-300 text-sm">
              <p>
                <strong>Subscription Billing:</strong> Automatic renewal unless cancelled. 
                Cancel anytime with immediate effect on next billing period.
              </p>
              <p>
                <strong>Refund Policy:</strong> 30-day money-back guarantee for annual plans. 
                Partial refunds calculated on pro-rata basis.
              </p>
              <p>
                <strong>Payment Security:</strong> All transactions processed through 
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="mailto:legal@jobequal.ch" className="text-jobequal-green hover:text-jobequal-green-hover">
                    legal@jobequal.ch
                  </a>
                </div>
                <div className="flex items-center space-x-3">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-yellow-700 dark:text-yellow-300 text-sm">
                ...
                via email to registered users at least 30 days before taking effect. Non-material changes 
                (such as clarifications or formatting updates) may be implemented immediately. 
