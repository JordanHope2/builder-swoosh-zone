...
import { MapPin, Clock, Building, Search, Filter, ChevronDown, Bookmark, Star, TrendingUp, Target, Zap, X } from 'lucide-react';
  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 border border-jobequal-neutral-dark hover:shadow-2xl transition-all duration-300 group">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-start space-x-3 sm:space-x-4 flex-1">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className={`inline-flex items-center space-x-1 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-bold border mb-2 ${getMatchColor(job.matchScore)}`}>
                <Zap className="w-3 h-3" />
                <span className="whitespace-nowrap">{job.matchScore}% AI Match</span>
              </div>
              ...
              <p className="text-jobequal-text-muted font-medium text-sm sm:text-base lg:text-lg mb-2">{job.company}</p>
            </div>
          </div>
        ...
        <p className="text-jobequal-text-muted leading-relaxed text-sm sm:text-base line-clamp-2 sm:line-clamp-3">{job.description}</p>
      ...
      <div className="pt-4 border-t border-jobequal-neutral-dark mt-4">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="flex items-center justify-between">
            <span className="text-xs sm:text-sm text-jobequal-text-muted">{job.posted}</span>
            <Link
              to={`/job/${job.id}`}
    ...
    <>
      <div className="flex items-center justify-between mb-6 lg:mb-8">
        <div className="flex items-center space-x-3">
          ...
          <h3 className="text-xl lg:text-2xl font-bold text-jobequal-text">Filters</h3>
        </div>
        {onClose && (
          <button
            onClick={onClose}
      ...
      <div className="space-y-6 lg:space-y-8">
        {/* Location Filter */}
        <div>
          <label className="block text-jobequal-text font-semibold mb-3 lg:mb-4 text-sm lg:text-base">Location</label>
          <select
        ...
        {/* Job Type Filter */}
        <div>
          <label className="block text-jobequal-text font-semibold mb-3 lg:mb-4 text-sm lg:text-base">Job Type</label>
          <select
        ...
        {/* Experience Filter */}
        <div>
          <label className="block text-jobequal-text font-semibold mb-3 lg:mb-4 text-sm lg:text-base">Experience Level</label>
          <select
        ...
        {/* Salary Filter */}
        <div>
          <label className="block text-jobequal-text font-semibold mb-3 lg:mb-4 text-sm lg:text-base">Salary Range</label>
          <select
        ...
        <div>
          <label className="flex items-center space-x-3 cursor-pointer">
            ...
            />
            <span className="text-jobequal-text font-semibold text-sm lg:text-base">Remote Work Available</span>
          </label>
        </div>
        ...
        <div className="lg:grid lg:grid-cols-4 lg:gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
              ...
              <div className="flex items-center space-x-3">
                <span className="text-jobequal-text-muted font-medium text-sm sm:text-base">Sort by:</span>
                <select
                  value={sortBy}
