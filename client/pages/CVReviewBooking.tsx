...
const reviewTypes = {
  standard: {
    ...
    duration: '45 minutes',
    price: 149,
    features: ['CV Analysis & Feedback', 'Skills Assessment', 'Written Report', 'Industry Insights'],
    icon: FileText,
  ...
  premium: {
    ...
    duration: '60 minutes',
    price: 199,
    features: ['Everything in Standard', 'LinkedIn Profile Review', 'Cover Letter Template', 'Interview Tips', 'Salary Negotiation Guide'],
    icon: Star,
  ...
  video: {
    ...
    duration: '90 minutes',
    price: 249,
    features: ['Everything in Premium', 'Live Video Session', 'Mock Interview', 'Career Coaching', 'Personalized Action Plan'],
    icon: Video,
...
export default function CVReviewBooking() {
  ...
  const getSlotTypeColor = (type: string) => {
    switch (type) {
      case 'premium': return 'border-purple-200 bg-purple-50 hover:bg-purple-100 text-purple-700';
      case 'video': return 'border-green-200 bg-green-50 hover:bg-green-100 text-green-700';
      default: return 'border-blue-200 bg-blue-50 hover:bg-blue-100 text-blue-700';
    }
  };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-lg text-jobequal-text-muted dark:text-gray-300 max-w-2xl mx-auto">
            Get expert feedback on your CV from Swiss recruitment professionals. Choose your preferred time and review type.
          </p>
        </motion.div>
              ...
              <div key={stepNumber} className="flex items-center">
                ...
                {stepNumber < 3 && (
                  <div className={`w-12 h-1 mx-2 ${
                    step > stepNumber ? 'bg-jobequal-green' : 'bg-gray-200 dark:bg-gray-700'
                  }`} />
                )}
              </div>
            ))}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-7 gap-1 mb-2">
                    {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(day => (
                      <div key={day} className="p-2 text-center text-sm font-medium text-jobequal-text-muted dark:text-gray-400">
                        {day}
                      </div>
                    ))}
                  </div>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="text-left">
                                ...
                                <div className="text-sm opacity-75">{reviewTypes[slot.type].duration}</div>
                              </div>
                            </div>
                            <div className="text-right">
                              <div className="font-bold">CHF {slot.price}</div>
                              <div className="text-sm opacity-75">{reviewTypes[slot.type].name}</div>
                            </div>
                          </div>
                        </motion.button>
                      ))}
            ...
            >
              ...
              <div className="bg-jobequal-green-light dark:bg-jobequal-green/20 rounded-xl p-4 mb-6">
                ...
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  <div>
                    <div className="text-jobequal-text-muted dark:text-gray-400">Date</div>
                  ...
                  <div>
                    <div className="text-jobequal-text-muted dark:text-gray-400">Time</div>
                    <div className="font-medium text-jobequal-text dark:text-white">{booking.time}</div>
                  </div>
                  <div>
                    <div className="text-jobequal-text-muted dark:text-gray-400">Service</div>
                    <div className="font-medium text-jobequal-text dark:text-white">
                      {reviewTypes[booking.type].name} - CHF {reviewTypes[booking.type].price}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setBooking(prev => ({ ...prev, currentRole: e.target.value }))}
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-jobequal-text dark:text-white focus:ring-2 focus:ring-jobequal-green focus:border-transparent"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setBooking(prev => ({ ...prev, experience: e.target.value }))}
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-jobequal-text dark:text-white focus:ring-2 focus:ring-jobequal-green focus:border-transparent"
                  >
              ...
              <div className="mt-6">
                ...
                <textarea
                  value={booking.goals}
                  onChange={(e) => setBooking(prev => ({ ...prev, goals: e.target.value }))}
                  rows={4}
                ...
                <div className="space-y-6">
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-jobequal-text-muted dark:text-gray-400">Date:</span>
                      ...
                      <div className="flex justify-between">
                        <span className="text-jobequal-text-muted dark:text-gray-400">Time:</span>
                        <span className="font-medium text-jobequal-text dark:text-white">{booking.time}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-jobequal-text-muted dark:text-gray-400">Duration:</span>
                        <span className="font-medium text-jobequal-text dark:text-white">
                          {reviewTypes[booking.type].duration}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-jobequal-text-muted dark:text-gray-400">Service:</span>
                        <span className="font-medium text-jobequal-text dark:text-white">
                          {reviewTypes[booking.type].name}
                        </span>
                      </div>
                      <div className="flex justify-between pt-3 border-t border-gray-200 dark:border-gray-600">
                        <span className="font-semibold text-jobequal-text dark:text-white">Total:</span>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {booking.currentRole && <div><strong>Current Role:</strong> {booking.currentRole}</div>}
                      {booking.experience && <div><strong>Experience:</strong> {booking.experience}</div>}
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <div className="bg-gradient-to-br from-jobequal-green-light to-jobequal-blue-light dark:from-jobequal-green/20 dark:to-jobequal-blue/20 rounded-xl p-6">
                    ...
                    <div className="space-y-2">
                      <h4 className="font-semibold text-jobequal-text dark:text-white mb-3">What's included:</h4>
                      {reviewTypes[booking.type].features.map((feature, index) => (
                        <div key={index} className="flex items-center text-sm text-jobequal-text dark:text-white">
                  ...
                  {booking.goals && (
                    <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 mt-6">
                      <h3 className="font-semibold text-jobequal-text dark:text-white mb-3">Your Goals:</h3>
                      <p className="text-sm text-jobequal-text-muted dark:text-gray-400">{booking.goals}</p>
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-blue-700 dark:text-blue-300">
                      You'll receive a confirmation email with meeting details and a secure upload link for your CV. 
                      Our expert will review your documents before the session for maximum efficiency.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {step === 4 && (
            ...
            >
              ...
              <p className="text-lg text-jobequal-text-muted dark:text-gray-300 mb-6 max-w-2xl mx-auto">
                Thank you {booking.firstName}! Your CV review appointment has been successfully booked. 
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-6 mb-6 max-w-md mx-auto">
                ...
                <div className="space-y-2 text-sm text-green-700 dark:text-green-300">
                  <div>📅 {booking.date?.toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })}</div>
