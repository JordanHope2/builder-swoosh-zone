          ...
          {[
            ...
            >
              ...
              <div className="text-3xl font-bold text-jobequal-text dark:text-white mb-1">
                {stat.value}
                {stat.total && (
                  <span className="text-lg text-jobequal-text-muted dark:text-gray-400">
                    /{stat.total}
                  </span>
                )}
              </div>
          ...
          <div className="grid grid-cols-5 gap-4">
            {pipelineStages.map((stage, index) => (
              <div key={index} className="text-center">
                <div
                  className={`w-full h-24 ${stage.color} rounded-xl flex items-center justify-center mb-3 relative overflow-hidden`}
                >
                ...
                <h4 className="font-semibold text-jobequal-text dark:text-white text-sm mb-1">
                  {stage.name}
                </h4>
                  ...
                  <motion.div
                    ...
                    className={`p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors cursor-pointer ${
                      selectedJob?.id === job.id
                        ? "bg-jobequal-green-light dark:bg-jobequal-green/10"
                        : ""
                    }`}
                    ...
                    selectedJob.applications.map((candidate, index) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div
                            className={`px-2 py-1 rounded-full text-xs font-medium ${getMatchColor(candidate.matchScore)}`}
                          >
