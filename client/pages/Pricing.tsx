...
export default function Pricing() {
  const [activeCategory, setActiveCategory] = useState<'job_seekers' | 'employers' | 'services'>('job_seekers');
  ...
  const getDisplayPrice = (price: number) => {
    ...
    const adjustedPrice = billingPeriod === 'yearly' ? Math.floor(price * 0.83) : price; // 17% discount for yearly
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-jobequal-neutral via-white to-jobequal-blue dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {(activeCategory === 'job_seekers' || activeCategory === 'employers') && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
                ...
                <div className="space-y-3 mb-8">
                  {plan.features.included.map((feature, idx) => (
                    <div key={idx} className="flex items-start space-x-3">
                      ...
                      <span className="text-jobequal-text dark:text-white text-sm">{feature}</span>
                    </div>
                  ))}
            ...
            {employerPlans.map((plan, index) => (
              ...
              >
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="mb-4">
                    <span className="text-4xl font-bold text-jobequal-text dark:text-white">
                      {plan.period === 'custom' ? 'Custom' : getDisplayPrice(plan.price)}
                    </span>
                    {plan.period !== 'custom' && (
                      <span className="text-jobequal-text-muted dark:text-gray-400">
                        /{billingPeriod === 'yearly' ? 'year' : plan.period}
                  ...
                  {billingPeriod === 'yearly' && plan.price > 0 && plan.period !== 'custom' && (
                    <p className="text-green-600 text-sm font-medium">
                      Save CHF {getYearlyDiscount(plan.price)} per year
                    </p>
                  )}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-jobequal-text-muted dark:text-gray-400 text-sm">
                  We offer a 30-day money-back guarantee for annual subscriptions and a 7-day free trial for premium plans.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-jobequal-text-muted dark:text-gray-400 text-sm">
                  No hidden fees, ever. All prices are transparent and include VAT where applicable.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-jobequal-text-muted dark:text-gray-400 text-sm">
                  Start with a 7-day free trial of our premium features. No credit card required. Upgrade anytime.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-jobequal-text-muted dark:text-gray-400 text-sm">
                  We accept all major credit cards, bank transfers, and PayPal. Enterprise clients can pay via invoice.
                </p>
              </div>
        ...
        >
          ...
          <p className="text-lg mb-6 opacity-90">
            Large organization? Special requirements? Let's create a plan that works for you.
          </p>
